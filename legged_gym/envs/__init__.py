...
from legged_gym.envs.g1.g1_goal_config import G1GoalRoughCfg, G1GoalRoughCfgPPO
from legged_gym.envs.g1.g1_goal_env import G1GoalRobot
...
task_registry.register( "g1_goal", G1GoalRobot, G1GoalRoughCfg(), G1GoalRoughCfgPPO())
